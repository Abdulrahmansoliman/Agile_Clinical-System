...
class Secretary(User):
    ...
    def __init__(self, username, password, email, first_name, last_name, birth_date, user_type, phone_number):
        super().__init__(username=username, password=password, email=email, first_name=first_name,
                         last_name=last_name, birth_date=birth_date, phone_number=phone_number, user_type=user_type, role='secretary')
